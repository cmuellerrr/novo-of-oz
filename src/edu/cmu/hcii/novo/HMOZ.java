...
public class HMOZ extends PApplet {
	...
	public static void main(String[] args) {
		PApplet.main(new String[] { "edu.cmu.hcii.novo.MidFi" });
	}
	...
	private void sendScreenUpdate() {
		String bg = screens.get(screenIndex) != null ? screens.get(screenIndex).path : "";
		String fg = activeMenu != null ? activeMenu.path : "";
